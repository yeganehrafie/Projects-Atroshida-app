...
const SharedPerfume = ({ searchTerm }) => {
  ...
  const baseUrl =
    "https://api.atroshida.ir/general/products?product_type=products&category=عطرهای-مردانه&locale=fa";
