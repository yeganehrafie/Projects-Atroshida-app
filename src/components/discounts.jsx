...
const DiscountsProducts = ({ searchTerm }) => {
  ...
  const baseUrl =
    "https://api.atroshida.ir/general/products?product_type=products&sort=special_offer&locale=fa";
  ...
  //اعمال فیلتر محصولات بر اساس قیمت
  const applyFilter = () => {
      ...
      <section className="products">
        <div className="container">
          <div className="alert" style={{ backgroundColor: "#ffe4c6" }}>
            ...
            <Link to="/discounts" className=" text-decoration-none link">
              تخفیفات ویژه
            </Link>
          </div>
            ...
            <div className="col-lg-3 col-md-3 col-xl-3 text-center g-4">
              <div className="card shadow-sm card-filter-price">
                ...
                <div className="card-footer bg-white text-end">
                  ...
                  <div>
                    <span>
                      <Link to="/mensPerfume" className=" text-decoration-none">
                        <i className=" bi  bi-box-arrow-in-left m-2"></i>
                        عطر های مردانه
                      </Link>
                    </span>
              ...
              <div className="d-flex justify-content-between align-items-center sorting">
                ...
                <div>
                  <span className="task-mode">
                    نمایش {currentProducts.length} از
